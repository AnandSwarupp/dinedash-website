                ...
                <div className="space-y-5">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-white font-medium">hello@dinedash.app</div>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="w-10 h-10 bg-[var(--brand)]/20 rounded-xl flex items-center justify-center flex-shrink-0">
                    ...
                    <div>
                      ...
                      <div className="text-white font-medium">+44 20 0000 0000</div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-white font-medium">London, United Kingdom</div>
                    </div>
                  </div>
                </div>
              </div>
