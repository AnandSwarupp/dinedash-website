...
const testimonials = [
  {
    ...
    quote: "Since we started with DineDash, our average table time dropped by 18 minutes. We're fitting in an extra turn during dinner service every night.",
    rating: 5,
    avatar: "S",
    color: "bg-green-600",
  },
  {
    name: "James K.",
    role: "Customer",
    quote: "Got 30% back on a £60 dinner because we finished quickly. The app is dead simple — scan, order, pay, eat, scan again. That's it.",
    rating: 5,
    avatar: "J",
    color: "bg-green-600",
  },
  {
    name: "Priya R.",
    role: "Restaurant Manager, Manchester",
    quote: "Setup took under an hour. We printed the QR codes, tested it ourselves, and went live. Our customers love the gamification of it.",
    rating: 5,
    avatar: "P",
    color: "bg-amber-500",
  },
...
const faqs = [
  {
    ...
    a: "No. DineDash creates an anonymous device ID the first time the app opens and stores it locally. We never ask for a name, email, or phone number. Your phone is your ticket.",
  },
  {
    q: "What if a customer takes longer than 45 minutes?",
    a: "They simply pay the full price — no penalty, no extra charges. The full amount was already collected upfront, so there's nothing more to do. The restaurant is always protected.",
  },
  {
    q: "How quickly do refunds appear?",
    a: "Refunds are processed via Stripe and typically appear on the customer's card within 3–5 business days, depending on their bank.",
  },
  {
    q: "Can restaurants customise their own time limits and discount percentages?",
    a: "Yes. Every restaurant can set their own time tiers and refund percentages from the owner dashboard. The app always shows the current restaurant's exact tiers.",
  },
  {
    q: "Do waitstaff need to use an app?",
    a: "No dedicated staff app is needed. Waitstaff simply point customers to the table QR code. The entire flow is customer-driven through their own phone.",
  },
  {
    q: "How does a restaurant get started?",
    a: "Sign up for a subscription, add your restaurant details and menu, then print your unique table QR codes and till QR code. You can be live in under an hour.",
  },
];
          ...
          <div className="grid lg:grid-cols-2 gap-14 items-center">
            ...
            <div className="flex justify-center lg:justify-end">
              <div className="relative">
                <div className="absolute -left-8 top-16 bg-[var(--surface)] rounded-2xl shadow-xl border border-[var(--border)] px-5 py-4 z-10">
                ...
                <div className="absolute -right-8 bottom-20 bg-[var(--surface)] rounded-2xl shadow-xl border border-[var(--border)] px-5 py-4">
